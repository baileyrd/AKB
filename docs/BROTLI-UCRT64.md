...
| Model fact | Value |
| --- | --- |
| Object | `library:google:brotli@ucrt64` |
| Kind | `library` |
| Status | `partial` |
| Confidence | `high` |
| Authority | Google |
...
| Packaged as | `package:msys2:mingw-w64-ucrt-x86_64-brotli` |
...
Dependencies and dependents of `library:google:brotli@ucrt64` in the composed graph: 2 dependents and 0 dependencies.
