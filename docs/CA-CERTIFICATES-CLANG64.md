...
| Model fact | Value |
| --- | --- |
| Object | `library:mozilla:ca-certificates@clang64` |
| Kind | `library` |
| Status | `partial` |
| Confidence | `high` |
| Authority | Mozilla |
| Environments | `clang64` |
| Upstream | <https://wiki.mozilla.org/CA> |
| Packaged as | `package:msys2:mingw-w64-clang-x86_64-ca-certificates` |
| Version (observed) | 20250419-1 |
| License (observed) | MPL;GPL |
| Architecture (observed) | any |
| Installed size (observed) | 1069.59 KiB |
