...
| Model fact | Value |
| --- | --- |
| Object | `library:gnu:mpfr@clang64` |
| Kind | `library` |
| Status | `partial` |
| Confidence | `high` |
...
| Packaged as | `package:msys2:mingw-w64-clang-x86_64-mpfr` |
| Version (observed) | 4.2.2-3 |
| License (observed) | spdx:LGPL-3.0-or-later |
| Architecture (observed) | any |
| Installed size (observed) | 1766.85 KiB |
...
Dependencies and dependents of `library:gnu:mpfr@clang64` in the composed graph: 1 dependent and 1 dependency.
