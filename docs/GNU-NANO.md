...
| --- | --- | --- |
| File-type detection | `package:msys2:file` | Likely used to help select a syntax-highlighting rule set for files without a recognized extension; this specific mechanism is a plausible but not manual-confirmed explanation, recorded at medium confidence. |
