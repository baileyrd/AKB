...
| Model fact | Value |
| --- | --- |
| Object | `library:gnu:termcap` |
| Kind | `library` |
| Status | `partial` |
| Confidence | `high` |
| Authority | GNU Project |
| Environments | `ucrt64` |
| Upstream | <https://www.gnu.org/software/termutils/> |
| Packaged as | `package:msys2:mingw-w64-ucrt-x86_64-termcap` |
| Version (observed) | 1.3.1-7 |
| License (observed) | GPL;LGPL |
| Architecture (observed) | any |
| Installed size (observed) | 67.67 KiB |

**Evidence on this object**

- `evidence:catalog:current` — MSYS2 pacman package catalog (`observed`, retrieved 2026-08-05)
- `evidence:gnu:termcap-manual-2026-07-30` — GNU termcap / termutils (official project page) (`primary`, retrieved 2026-07-30)
...
modeled (`relationship:foundation-libraries:termcap-requires-libstdcxx`,
added 2026-07-30).
...
Dependencies and dependents of `library:gnu:termcap` in the composed graph: 1 dependent and 1 dependency.
