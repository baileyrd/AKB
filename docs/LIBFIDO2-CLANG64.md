...
| Model fact | Value |
| --- | --- |
| Object | `library:yubico:libfido2@clang64` |
| Kind | `library` |
| Status | `partial` |
| Confidence | `high` |
| Authority | Yubico |
...
| Packaged as | `package:msys2:mingw-w64-clang-x86_64-libfido2` |
| Version (observed) | 1.17.0-3 |
| License (observed) | BSD-2-Clause |
| Architecture (observed) | any |
| Installed size (observed) | 1556.16 KiB |
...
Dependencies and dependents of `library:yubico:libfido2@clang64` in the composed graph: 0 dependents and 3 dependencies.
