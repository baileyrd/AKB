...
| Model fact | Value |
| --- | --- |
| Object | `library:gnupg:libksba@clang64` |
| Kind | `library` |
| Status | `partial` |
| Confidence | `high` |
...
| Packaged as | `package:msys2:mingw-w64-clang-x86_64-libksba` |
| Version (observed) | 1.6.8-1 |
| License (observed) | GPL |
| Architecture (observed) | any |
| Installed size (observed) | 705.65 KiB |
