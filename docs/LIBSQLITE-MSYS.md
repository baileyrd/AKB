...
| Model fact | Value |
| --- | --- |
| Object | `library:sqlite:libsqlite@msys` |
| Kind | `library` |
| Status | `partial` |
| Confidence | `high` |
| Authority | SQLite project |
| Environments | `msys` |
| Upstream | <https://www.sqlite.org/> |
| Packaged as | `package:msys2:libsqlite` |
| Version (observed) | 3.53.3-1 |
| License (observed) | spdx:LicenseRef-Sqlite |
| Architecture (observed) | x86_64 |
| Installed size (observed) | 1537.46 KiB |
