...
| Packaged as | `package:msys2:mingw-w64-ucrt-x86_64-lz4` |
| Version (observed) | 1.10.0-1 |
| License (observed) | BSD;GPL2 |
| Architecture (observed) | any |
| Installed size (observed) | 1605.09 KiB |
...
Dependencies and dependents of `library:lz4:lz4@ucrt64` in the composed graph: 1 dependent and 0 dependencies.
