...
| Model fact | Value |
| --- | --- |
| Object | `library:openssl:openssl@clang64` |
| Kind | `library` |
| Status | `partial` |
| Confidence | `high` |
...
| Packaged as | `package:msys2:mingw-w64-clang-x86_64-openssl` |
| Version (observed) | 3.6.3-1 |
| License (observed) | spdx:Apache-2.0 |
| Architecture (observed) | any |
| Installed size (observed) | 55.47 MiB |
...
Dependencies and dependents of `library:openssl:openssl@clang64` in the composed graph: 5 dependents and 0 dependencies.
