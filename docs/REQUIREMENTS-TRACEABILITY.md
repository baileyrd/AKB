...
| Interactive Explorer | Partial | Stable routes, search, filters, dependency navigation, zoomable per-object graph rendering with keyboard equivalents and a textual equivalent | Complete populated object categories |
