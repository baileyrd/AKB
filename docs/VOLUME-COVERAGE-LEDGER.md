...
| 5 GNU Userland | [GNU userland role model](GNU-USERLAND-ROLE-MODEL.md), [GNU Bash](GNU-BASH.md), [GNU Coreutils](GNU-COREUTILS.md), [GNU Grep](GNU-GREP.md), [GNU Sed](GNU-SED.md), [GNU Awk (gawk)](GNU-AWK.md), [GNU Findutils](GNU-FINDUTILS.md), [GNU Tar](GNU-TAR.md), [GNU Gzip](GNU-GZIP.md), [bzip2](BZIP2.md), [XZ Utils](XZ-UTILS.md) | Partial | Bash, Coreutils, Grep, Sed, Awk, Findutils, Tar, Gzip, bzip2, and XZ Utils now have evidence-backed per-tool pages; zstd, zip/unzip, p7zip, lzip, cpio, lz4, editors/pagers/terminals, and SSH/curl/Git-adjacent tools still need per-tool startup, configuration, dependency, and interaction pages |
