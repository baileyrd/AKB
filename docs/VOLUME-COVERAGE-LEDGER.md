...
| 2 Windows Platform | Cross-volume Windows boundaries in [domain decomposition](DOMAIN-DECOMPOSITION.md) and [runtime map](MSYS-RUNTIME-BEHAVIOR-MAP.md) | Gap | Canonical Windows platform page covering APIs, console/ConPTY, filesystem, registry, security, and networking boundaries |
...
| 6 Libraries | [Library family classification](LIBRARY-FAMILY-CLASSIFICATION.md), [header and metadata indexes](HEADER-AND-METADATA-INDEXES.md) | Partial | Canonical Volume 6 landing page and observed family-level package/artifact coverage beyond the bounded installation |
...
| 12 Source Code Organization | Recipe-tree collectors and [Git for Windows package/source mappings](GIT-FOR-WINDOWS-PACKAGE-SOURCE-MAPPINGS.md) | Partial | Canonical source-organization page and package-to-source-to-artifact proof |
...
| 15 Extension and Plugin Architecture | No canonical material | Gap | Extension points, safe plugin boundaries, lifecycle, and evidence model |
